...
public class ResponseTemplateManager {
    ...
    private static final String FAHRT_NICHT_ERFOLGT_DEFAULT_TEMPLATE_TEXT = "Guten Tag,\n"+
            ...
            "Dass Sie von dieser Störung betroffen waren, bedauern wir und entschuldigen uns für die Unannehmlichkeiten, die Ihnen hieraus entstanden sind.\n"+
            "Für die Zukunft wünschen wir Ihnen reibungslose Fahrten mit unseren Verkehrsmitteln.";

    private static final String FAHRER_UNFREUNDLICH_DEFAULT_TEMPLATE_TEXT = "Guten Tag,\n" +
            "vielen Dank für Ihre Beschwerde, die am %s bei uns im System eingegangen ist.\n" +
            ...
            "Diesen Vorfall bedauern wir und lassen den Fahrer durch den zuständigen Fachbereich ansprechen.\n" +
            "Wir hoffen damit in Ihrem Sinn gehandelt zu haben.\n" +
            "Für die Zukunft wünschen wir Ihnen reibungslose Fahrten.";

    private static final String SONSTIGES_DEFAULT_TEMPLATE_TEXT = "Guten Tag,\n" +
            "vielen Dank für Ihre Beschwerde, die am %s bei uns im System eingegangen ist.\n" +
            "Wir haben die zuständigen Fachbereiche über den Sachverhalt verständigt.\n" +
            "Bitte haben Sie Verständnis dafür, dass wir, das Beschwerdemanagement, in die Problemlösung nicht immer eingebunden sind.\n" +
            "Daher können wir Ihnen momentan keine zufriedenstellende Antwort geben. Das bedauern wir sehr.\n" +
            "Für die Zukunft wünschen wir Ihnen allzeit gute Fahrt.";

    private static final String MISSING_SUBJECT_DEFAULT_TEMPLATE_TEXT = "Danke für ihre Nachricht vom %s!";
     ...
     */
    public ResponseTemplate addTemplate(TemplateRepository templateRepository, String templateText, String subject, String responsePart) {
        ResponseTemplate responseTemplate = ResponseTemplateFactory.createTemplate(templateText, subject, responsePart);
     ...
     */
    public ResponseTemplate getTemplateBySubject(TemplateRepository templateRepository, String subject) {
        ...
        if (possibleTemplates.isEmpty()) {
            ...
            ResponseTemplate responseTemplate = ResponseTemplateFactory.createTemplate(templateText, subject, "COMPLETE_TEXT");
            templateRepository.save(responseTemplate);
            return responseTemplate;
        }
        ...
        return possibleTemplates.get(randomizer.nextInt(possibleTemplates.size()));
    }
    ...
    private String getDefaultTemplateText(String subject) {
        String templateText = MISSING_SUBJECT_DEFAULT_TEMPLATE_TEXT;
        switch(subject) {
