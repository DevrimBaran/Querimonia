...
/**
 * This recognizer is used to find money values in the complaint and generate a simple answer
 * message. It uses textominado as external extractor.
 */
public class TextominadoTestRecognizer {

  private static final String URL =
      "https://textominado.iao.fraunhofer.de/backend/entity-recognition/money-amount";
  ...
  private AnnotatedText generateAnnotatedText(String input,
