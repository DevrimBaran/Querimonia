...
public class ComplaintFilterTest {
    ...
    public void testFilterByDateStandard() {
        ...
        assertTrue(ComplaintFilter.filterByDate(testComplaint, optionalMinDateString, optionalMaxDateString));
    }
    ...
    public void testFilterByDateBelowMinDate() {
        ...
        assertFalse(ComplaintFilter.filterByDate(testComplaint, optionalMinDateString, optionalMaxDateString));
    }
    ...
    public void testFilterByDateNoMinDate() {
        ...
        assertTrue(ComplaintFilter.filterByDate(testComplaint, Optional.empty(), optionalMaxDateString));
    }
    ...
    public void testFilterByDateNoMaxDate() {
        ...
        assertTrue(ComplaintFilter.filterByDate(testComplaint, optionalMinDateString, Optional.empty()));
    }
    ...
    public void testCreateComplaintComparatorUndefinedSortingByDatesPositive() {
        Comparator<Complaint> complaintComparator = ComplaintFilter.createComplaintComparator(Optional.empty());
    ...
    public void testCreateComplaintComparatorUploadDateSortingByDatesPositive() {
        ...
        Comparator<Complaint> complaintComparator = ComplaintFilter.createComplaintComparator(optionalSortBy);
