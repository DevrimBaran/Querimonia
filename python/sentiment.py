...
if __name__ == '__main__':
    ...
    test_pos = "Ich hasse dich und liebe dich"
    test_neg = "Ich hasse Ananas auf Pizza, Menschen die Ananas auf Pizza essen soll man anzünden"
    sentiment_value = positive_sentiment(test_neg) + negative_sentiment(test_neg)

    #print(sentiment_value)
    # Write something in command lines
